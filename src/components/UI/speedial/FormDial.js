...
const FormDial = () => {
  return (
    <div className='absolute flex flex-col space-y-6 items-center justify-center bottom-6 left-32 w-[29rem] py-6 bg-accent opacity-90 rounded-sm'>
        ...
        <form method="POST" action="https://www.formbackend.com/f/664decaabbf1c319">
            ...
            <button type="submit" className='bg-info text-white px-6 py-2 rounded-sm'>Subscribe</button>
            </div>
        </form>
    </div>
  )
